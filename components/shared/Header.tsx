              ...
              if (link.title === 'Home') {
                return (
                  <div className="flex items-center space-x-6" key="home-group">
                    <Link
                      href={href}
                      className={`font-medium transition-colors whitespace-nowrap ${isActive
        ...
        <div className="flex items-center leading-5 space-x-4 sm:space-x-6">
          <div className="hidden lg:flex items-center space-x-6 border-l border-white/10 pl-6">
            <Link
              ...
              className={`flex items-center font-medium transition-colors ${pathname.includes('/category/Docs')
                  ? 'text-orange-500 font-bold'
                  : 'text-gray-100 hover:text-orange-500'
                }`}
            >
            ...
            {isLoggedIn && (session?.user as any)?.isAdmin && (
              <Link
                href="/admin/stats"
                className={`flex items-center font-medium transition-colors ${pathname === '/admin/stats'
                    ? 'text-orange-500 font-bold'
                    : 'text-gray-100 hover:text-orange-500'
                  }`}
              >
