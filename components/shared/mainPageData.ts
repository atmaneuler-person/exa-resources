export const mainPageData: Record<string, any> = {
  en: {
    ...
    blogHero: {
      ...
      subtitle: "Enterprise Platform Logic & Technical Synthesis",
      desc: "Our research decodes the Physics of Business—translating high-dimension chaos into actionable intelligence for the low-dimension decision landscape.",
      viewAll: "Explore the Synthesis"
    },
    exawin: {
      label: "Deploy Evidence-Based Sales Intelligence",
      title: "EXAWin:",
