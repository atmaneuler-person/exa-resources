              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm font-bold text-white">exa@exaeuler.com</p>
                  </div>
                </motion.div>
              </div>
                ...
                >
                  <form
                    ...
                    onSubmit={(e) => {
                      ...
                      window.location.href = `mailto:exa@exaeuler.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
                    }}
                  >
                    <div className="space-y-2">
